    ...
    void loadGlobalConfig(GlobalConfig &config)
    {
        ...
        if (num_comp_channels_per_ctx_env)
        {
            ...
            if (val > 0 && val < 256)
                ...
                LOG(WARNING) << "Ignore value from environment variable MC_NUM_COMP_CHANNELS_PER_CTX";
        }
        ...
        if (mtu_length_env)
        {
            ...
            {
                LOG(ERROR) << "Ignore value from environment variable MC_MTU, it should be 512|1024|2048|4096";
                exit(EXIT_FAILURE);
            }
        }
