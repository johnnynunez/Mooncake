...
namespace mooncake
{
    ...
    using TransferRequest = RdmaTransport::TransferRequest;
    using TransferStatus = RdmaTransport::TransferStatus;
    using TransferStatusEnum = RdmaTransport::TransferStatusEnum;
    using SegmentID = RdmaTransport::SegmentID;
    using BatchID = RdmaTransport::BatchID;
}
